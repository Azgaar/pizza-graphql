const {GraphQLObjectType, GraphQLNonNull, GraphQLList, GraphQLID, GraphQLInt, GraphQLString} = require("graphql");
...
const PizzaType = new GraphQLObjectType({
  ...
  fields: {
    ...
    modifications: {
      ...
      resolve(parentValue) {
        return modificationsData.filter(modification => modification.pizzasIds.includes(parentValue.id));
      }
    }
  }
});
